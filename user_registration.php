...
if (isset($_POST['name'])) {
  ...
  if(!filter_var($email,FILTER_VALIDATE_EMAIL) || !checkdnsrr($domain[1])){
    echo 'Your Email is invalid., <a href="user_registration.php">Refill here</a>';
    exit();
  }
  if((strlen($mobile) != 10) ||(!ctype_digit($mobile))){
    echo 'Your Mobile Number is invalid., <a href="user_registration.php">Refill here</a>';
    exit();
  }
