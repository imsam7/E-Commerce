...
if (isset($_POST['product_name'])) {
	...
	$sql = mysql_query("INSERT INTO products (product_name, price, details, category, subcategory, date_added)
     ...
     $pid = mysql_insert_id();
	$newname = "$pid.jpg";
	if(move_uploaded_file( $_FILES['fileField']['tmp_name'], "C:/xampp/htdocs/SoftwareP/inventory_images/$newname"))
  {
    echo 'Successful.';
  }
	header("location: inventory_list.php");
...
<div align="center" id="mainWrapper">
  <?php include_once("../template_header.php");?>
    <div id="pageContent"><br />
      <div align="right" style="margin-right:32px"> <a href="http://localhost/SoftwareP/storeadmin/logout.php">Logout</a> &middot;
